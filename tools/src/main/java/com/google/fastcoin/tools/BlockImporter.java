...
import com.google.fastcoin.core.FullPrunedBlockChain;
...
import com.google.fastcoin.store.H2FullPrunedBlockStore;
...
public class BlockImporter {
    public static void main(String[] args) throws Exception {
        ...
        if (System.getProperty("os.name").toLowerCase().indexOf("win") >= 0) {
            defaultDataDir = System.getenv("APPDATA") + "\\.fastcoin/";
        } else {
            defaultDataDir = System.getProperty("user.home") + "/.fastcoin/";
        }
