...
public class BuildCheckpoints {
    public static void main(String[] args) throws Exception {
        ...
        // Configure fastcoinj to fetch only headers, not save them to disk, connect to a local fully synced/validated
        ...
        final FileOutputStream fileOutputStream = new FileOutputStream("fastcoin-checkpoints", false);
