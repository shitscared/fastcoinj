...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        // copied verbatim from https://en.fastcoin.it/wiki/Protocol_specification#Network_address
        ...
        String reserialized = Utils.bytesToHexString(pa.fastcoinSerialize());
        assertEquals(reserialized,fromSpec );
    }

    @Test
    public void testFastcoinSerialize() throws Exception {
        ...
        assertEquals("000000000000000000000000000000000000ffff7f000001208d",
                Utils.bytesToHexString(pa.fastcoinSerialize()));
    }
}
