...
package com.google.fastcoin.script;
...
import static com.google.fastcoin.script.ScriptOpCodes.*;
import static com.google.fastcoin.core.Utils.bytesToHexString;
 ...
 *
 * <p>Bitcoin transactions don't specify what they do directly. Instead <a href="https://en.fastcoin.it/wiki/Script">a
...
public class Script {
     ...
     * logic is defined by <a href="https://en.fastcoin.it/wiki/BIP_0016">BIP 16</a>.</p>
     *
     * <p>fastcoinj does not support creation of P2SH transactions today. The goal of P2SH is to allow short addresses
    ...
    public void correctlySpends(Transaction txContainingThis, long scriptSigIndex, Script scriptPubKey,
        ...
        try {
            txContainingThis = new Transaction(txContainingThis.getParams(), txContainingThis.fastcoinSerialize());
