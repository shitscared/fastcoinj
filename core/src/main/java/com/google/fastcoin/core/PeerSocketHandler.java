...
import com.google.fastcoin.net.AbstractTimeoutHandler;
import com.google.fastcoin.net.MessageWriteTarget;
import com.google.fastcoin.net.StreamParser;
 ...
 * {@link com.google.fastcoin.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.google.fastcoin.net.NioClient} or
     * {@link com.google.fastcoin.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
