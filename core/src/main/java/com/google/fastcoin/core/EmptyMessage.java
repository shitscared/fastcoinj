 ...
 * Currently this includes getaddr, ping, verack as well as the special fastcoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void fastcoinSerializeToStream(OutputStream stream) throws IOException {
    }
