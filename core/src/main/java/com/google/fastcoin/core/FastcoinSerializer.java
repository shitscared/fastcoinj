 ...
 * <a href="https://en.fastcoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.fastcoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class FastcoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(FastcoinSerializer.class);
    ...
    /**
     * Constructs a FastcoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public FastcoinSerializer(NetworkParameters params) {
     ...
     */
    public FastcoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("FastcoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.fastcoinSerialize();
     ...
     * {@link FastcoinSerializer#deserializeHeader}.
     */
