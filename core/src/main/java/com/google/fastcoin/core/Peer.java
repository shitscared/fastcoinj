 ...
 * {@link com.google.fastcoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.fastcoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that fastcoin-qt is single threaded and processes messages in order.
    ...
    // fork. As fastcoin didn't change the version message to distinguish client versions,
     ...
     * {@link com.google.fastcoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.fastcoin.net.StreamParser)}
     * or
     * {@link com.google.fastcoin.net.NioClient#NioClient(java.net.SocketAddress, com.google.fastcoin.net.StreamParser, int)}.</p>
     *
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // fastcoinj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash) {
        ...
        //
        //   https://en.fastcoin.it/wiki/Protocol_specification#getblocks
        //
     ...
     * Once the pong is received the value returned by {@link com.google.fastcoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.fastcoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.fastcoin.core.Peer#ping()} has never
    ...
    private boolean isNotFoundMessageSupported() {
        return vPeerVersionMessage.clientVersion >= 70001; //70002?
    }
