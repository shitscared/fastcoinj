...
public class PeerFinder {
        ...
        public static void main(String[] args) throws Exception {
            ...
            new PeerFinder(false, false, args);  //SPV
        }
        ...
        public PeerFinder(boolean testnet, boolean fullChain, String[] args) throws Exception {
         ...
         //   }
          ...
          /*
            ...
            File blockChainFile = new File("h2.blockchain");
            ...
            peerGroup.setMaxConnections(60000000);
                ...
                public void run() {
                 ...
                 //   StoredBlock chainHead = chain.getChainHead();
                  //  String date = chainHead.getHeader().getTime().toString();
                    String status = String.format("%d peer(s) connected. ",
                            numPeers);//, chainHead.getHeight(), date);  %d blocks: %s
