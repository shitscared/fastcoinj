...
public class ToyWallet {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // new ToyWallet(false, true, args);
        ...
        new ToyWallet(false, false, args);  //SPV
    }
            ...
            switch (col) {
                ...
                case 2:
                    try {
                        ...
                        return Utils.fastcoinValueToFriendlyString(val);
    ...
    public ToyWallet(boolean testnet, boolean fullChain, String[] args) throws Exception {
        ...
        File blockChainFile = new File("spv.blockchain");
      ...
      //  if (fullChain) {
       ...
       // MySQLFullPrunedBlockStore store = new MySQLFullPrunedBlockStore(params, "203.194.26.204:3306/blockchain?user=root&password=4746",100);
        // MySQLBlockStore store = new MySQLBlockStore(params,"203.194.26.204:3306/blockchain?user=root&password=4746");  //203.194.26.204
      ...
      //      peerGroup.addAddress(InetAddress.getByName("10.0.127.97"));
        ...
        peerGroup.addEventListener(new AbstractPeerEventListener() {
            ...
            public void onTransaction(Peer peer, Transaction t) {
                System.out.println("tx ->"+t.getHash()+" ");
