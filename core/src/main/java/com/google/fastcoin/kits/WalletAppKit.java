...
package com.google.fastcoin.kits;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV fastcoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit fastcoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing fastcoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the fastcoinj website for further details.
     */
