...
package com.google.fastcoin.examples;
 ...
 * <li>Start your fastcoin client in test mode <code>fastcoin -testnet</code>. This will create a new sub-directory called testnet and should not interfere with normal wallets or operations.</li>
 * <li>(Optional) Choose a fresh address</li>
 * <li>(Optional) Visit the Testnet faucet (https://testnet.freefastcoins.appspot.com/) to load your client with test coins</li>
 * <li>Run <code>PingService testnet</code></li>
 * <li>Wait for the block chain to download</li>
 * <li>Send some coins from your fastcoin client to the address provided in the PingService console</li>
 ...
 * .net/projects/fastcoin/files/Litecoin/testnet-in-a-box/">testnet in a box</a> to do everything purely locally.</p>
 */
public class PingService {
    ...
    public PingService(String[] args) throws Exception {
        ...
        wallet.addEventListener(new AbstractWalletEventListener() {
            ...
            public void onCoinsReceived(Wallet w, Transaction tx, BigInteger prevBalance, BigInteger newBalance) {
                ...
                System.out.println("Received pending tx for " + Utils.fastcoinValueToFriendlyString(value) +
                        ": " + tx);
    ...
    private void bounceCoins(final Wallet wallet, Transaction tx) {
        ...
        try {
            ...
            System.out.println("Received " + Utils.fastcoinValueToFriendlyString(value) + " from " + from.toString());
