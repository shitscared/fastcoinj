 ...
 *
 * <a href="http://www.fastcoin.org/smf/index.php?topic=3638.0">http://www.fastcoin.org/smf/index.php?topic=3638
 * .0</a><p>
 *
...
public class PrivateKeys {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // And take them!
            System.out.println("Claiming " + Utils.fastcoinValueToFriendlyString(wallet.getBalance()) + " coins");
